...
- [x] **CLM-03**: The metrics section matches the reference report's **labels and order** (including its exact, slightly garbled label text such as "STR State National Avg. for Hospitalization" and the bare "ED Visit" line); displayed **values come from the fixture/live API**, not the reference PDF's illustrative numbers
